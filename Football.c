//Program: Football.c
//Purpose: when given a football score, the program prints what plays could be made to get to the score
//Inputs: user input of a score <1
//Outputs: prints the football plays for the score given
